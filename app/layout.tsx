    ...
    <UserProvider user={session.user} >
      <html lang="en">
        <head>
          ...
          <style>
            @import url('https://fonts.googleapis.com/css2?family=Anybody:ital,wght@0,100..900;1,100..900&family=Jost:ital,wght@0,100..900;1,100..900&display=swap');
          </style>
        </head>

        <body className="bg-gradient-to-b  from-slate-200 from-50% via-slate-300  to-slate-500 to-90% anybody-fonty">
